...
public class EntityReader {
    ...
    private static Class<? extends Entity> getClassByCsvFile(final String csvFile) {
        if (csvFile.contains("room")) {
            return Room.class;
        } else if (csvFile.contains("apartment")) {
                ...
                if (field != null) {
                    ...
                    if (field.getName().equals("roomId")) {
                        if (entity instanceof Apartment) {
                            ...
                            List<Entity> rooms = entityMap.get(Room.class);
                            Room room = null;
                            if (rooms != null) {
                                for (Entity e : rooms) {
                                    Room r = (Room) e;
                            ...
                            field.set(entity, roomId);
                            Field roomField = getFieldByName(fields, "room");
                            if (roomField != null) {
                                roomField.setAccessible(true);
                                roomField.set(entity, room);
                            }
                        }
                    } else {
